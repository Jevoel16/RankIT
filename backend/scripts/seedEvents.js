...
const EVENT_BLUEPRINTS = [
  {
    ...
    criteria: [
      ...
      { label: 'Creativity', description: 'Originality and style choices', maxScore: 10, weight: 35 },
      { label: 'Stage Presence', description: 'Confidence and audience impact', maxScore: 10, weight: 25 },
      { label: 'Artistic Expression', description: 'Costume and presentation', maxScore: 10, weight: 5 }
    ],
